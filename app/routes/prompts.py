...
from app.models import analytics_competitors, analytics_scan_schedules, analytics_topics, analytics_tracked_prompts
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/tracking', methods=['GET'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/topics', methods=['POST'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/topics/<int:topic_id>', methods=['DELETE'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/competitors', methods=['POST'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/competitors/<int:competitor_id>', methods=['DELETE'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/tracked-prompts', methods=['POST'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/tracked-prompts/<int:prompt_id>', methods=['PATCH', 'DELETE'])
...
@prompts_bp.route('/api/analytics/projects/<int:project_id>/scan-schedule', methods=['PUT'])
